...
package com.thomaskioko.paybillmanager.ui.view;
...
public class FloatLabelLayout extends LinearLayout {
    ...
    private static final float DEFAULT_LABEL_PADDING_LEFT = 10f;
    private static final float DEFAULT_LABEL_PADDING_TOP = 3f;
    ...
    public FloatLabelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLabel.setTextSize(DEFAULT_LABEL_TEXT_SIZE_MICRO);
        mLabel.setTextColor(context.getResources().getColor(R.color.colorPrimary));
    ...
    private void setEditText(EditText editText) {
        ...
        mEditText = editText;
        mEditText.setTextSize(DEFAULT_LABEL_TEXT_SIZE_SMALL);
     ...
     * Show the label
     *
     * @param animate {@link Boolean} Animate the label
     */
     ...
     * Hide the label
     *
     * @param animate {@link Boolean} Hide the label
     */
