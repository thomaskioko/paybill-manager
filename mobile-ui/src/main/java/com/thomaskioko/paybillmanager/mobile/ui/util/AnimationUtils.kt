...
object AnimationUtils {
    ...
    const val animationDuration = 550.toLong()
    fun registerCircularRevealAnimation(view: View,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            view.addOnLayoutChangeListener(object : View.OnLayoutChangeListener {
                override fun onLayoutChange(_view: View?, left: Int, top: Int, right: Int, bottom: Int,
                    ...
                    val anim = ViewAnimationUtils.createCircularReveal(_view, cx, cy, 0f, finalRadius)
